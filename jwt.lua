-- © Optum 2018 - See https://github.com/Optum/kong-upstream-jwt/blob/master/src/access.lua
-- Edited by Skyline
...
local function supplement_payload(base_payload, payload)
  local new_payload = {}
  shallow_copy_table(base_payload, new_payload)
  shallow_copy_table(payload, new_payload)
  return new_payload
end
